...
class TestMechanic(unittest.TestCase):
    ...
    def test_invalid_creation(self):
        not_mechanic_payload = {
        "mechanic_name": "John Doe",
        "mechanic_phone": "123-456-7890",
        "mechanic_salary": "123"       
        }

        response = self.client.post('/mechanics', json=not_mechanic_payload)
    ...
    def test_update_mechanic(self):
        update_payload = {
            ...
            "mechanic_email": "nottest@email.com",
    ...
    def test_get_mechanic(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json['mechanic_name'], "test_user")
